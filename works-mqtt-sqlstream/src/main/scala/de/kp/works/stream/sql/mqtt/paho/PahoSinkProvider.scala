...
class PahoSinkProvider extends DataSourceV2 with StreamWriteSupport
  ...
  options: DataSourceOptions): StreamWriter = {
    ...
    new PahoStreamWriter(pahoOptions, outputMode, schema)
  }

  override def shortName(): String = "pahoSink"
